...
export class CoverpicComponent implements OnInit, AfterViewInit {
	...
	@ViewChild('coverPic', {static: true}) coverPic: ElementRef;
	@ViewChild('coverPicFileInput', {static: true}) coverPicFileInput: ElementRef;
	@ViewChild('coverPicModal', {static: true}) coverPicModal;
