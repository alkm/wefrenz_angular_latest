import { Component, HostListener, ElementRef, Input, ViewChild, OnInit, AfterViewInit,EventEmitter, Output } from '@angular/core';
...
export class StoryBoxComponent implements OnInit {
	...
	@ViewChild('storyBox', {static: true}) storyBox: ElementRef;
	@ViewChild('storyFeed', {static: true}) storyFeed: ElementRef;
	//@ViewChild('storyModal') storyModal;
	@ViewChild('musicInput', {static: true}) musicInput;
	@ViewChild('musicPlayer', {static: true}) musicPlayer: ElementRef;
