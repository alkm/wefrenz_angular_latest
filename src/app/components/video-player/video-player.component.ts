import { Component, ViewChild, ViewContainerRef, ElementRef, ComponentRef, ComponentFactoryResolver, OnInit } from '@angular/core';
...
export class VideoPlayerComponent implements OnInit {
	...
	//@ViewChild('videoList', {static: true}) videoList: ViewContainerRef;
	@ViewChild(MediaListDirective, {static: true}) appMediaList: MediaListDirective;
	...
	private videoListRef: ComponentRef<any>;
