...
export class AvchatComponent implements OnInit {
	...
	@ViewChild('selfVideo', {static: true}) selfVideo;
	@ViewChild('callerVideo', {static: true}) callerVideo;

	@ViewChild('shareAudio', {static: true}) shareAudio;
	@ViewChild('shareVideo', {static: true}) shareVideo;
	@ViewChild('expectVideo', {static: true}) expectVideo;
	@ViewChild('expectAudio', {static: true}) expectAudio;

	@ViewChild('connectButton', {static: true}) connectButton;
	@ViewChild('disconnectButton', {static: true}) disconnectButton;
	@ViewChild('hangupButton', {static: true}) hangupButton;
	@ViewChild('iam', {static: true}) iam;
	@ViewChild('otherClients', {static: true}) otherClients;
