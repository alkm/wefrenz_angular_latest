...
export class ChatComponent implements OnInit, AfterViewInit, OnDestroy {
	...
	@ViewChild('appChatWindow', {static: true}) appChatWindow;
	...
	ngOnInit() {
		...
		(window as any).app.namespace = (window as any).app.namespace || {};
		(window as any).app.namespace.callFromExternalInterface = this.callFromExternalInterface.bind(this);
	}

	ngOnDestroy() {
		(window as any).app.namespace.callFromExternalInterface = null;
	}
